...
namespace DoAnASPnet.Controllers
{
    public class ChitietdonhangsController : Controller
    {
        ...
        public ChitietdonhangsController(DoAnASPnetContext context)
        {
            _context = context;
        }
        ...
        {
            var doAnASPnetContext = _context.Chitietdonhang.Include(c => c.Donhang).Include(c => c.Sanpham);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SanphamId"] = new SelectList(_context.Set<Sanpham>(), "Id", "Tensp");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DonhangId,SanphamId,Soluong,Dongia")] Chitietdonhang chitietdonhang)
        {
            ...
            ViewData["SanphamId"] = new SelectList(_context.Set<Sanpham>(), "Id", "Tensp", chitietdonhang.SanphamId);
            return View(chitietdonhang);
        }
